...
PolyhedronC = Polyhedra.hrep(Polyhedra.polyhedron(ConvexHullC))
PolyhedronB = Polyhedra.hrep(Polyhedra.polyhedron(ConvexHullB))

# Save enveloping constraints for columns and beams:
HalfSpacesC = PolyhedronC.halfspaces
...
HalfSpacesB = PolyhedronB.halfspaces
